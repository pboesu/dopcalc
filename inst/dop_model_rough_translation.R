...
fid = file('data/gps_almanac/current.al3', 'r'); #Open source file "current.al3"
#Common Data
NumSV_name = scan(fid, nlines = 1, what = character());
...
summertime = 0; #To account for daylight saving. If summer, 1 = Yes, 0 = No
leapsec = 0; #leap second
#--------------------------
